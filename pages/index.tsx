    ...
    <div className="dark">
      <div className="bg-red-100 px-20 py-10 grid gap-10 xl:grid-cols-3 lg:grid-cols-2 place-content-center dark">
        ...
        <div className="bg-white p-10 shadow-lg rounded-lg mx-auto dark:bg-black">
          ...
          <div className="font-semibold bg-blue-500 text-white p-3 mt-4  mx-auto text-center rounded-lg hover:opacity-80 hover:scale-105 active:bg-red-400">
            Checkout
          </div>
        </div>
          ...
          <div className="bg-white rounded-3xl relative -top-20 px-8 py-5  shadow-lg">
            ...
            <div className="relative -top-24">
              ...
              <div className="flex flex-col items-center -mt-5 -mb-10">
                <span className="font-bold text-xl m-5">Tony Molloy</span>
        ...
        <div className="bg-slate-200 p-10 shadow-lg rounded-lg w-3/4 mx-auto ">
          ...
          />
          <div>
            <p className="first-letter:text-7xl fi">
